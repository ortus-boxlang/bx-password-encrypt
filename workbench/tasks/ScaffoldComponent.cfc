...
component {
	...
	function init(){
		...
		variables.util
			.addMapping( '/componentsDirectory',	"#variables.root#/src/main/java/ortus/boxlang/modules/encrypt/components" )
			.addMapping( '/componentsTestsDirectory', "#variables.root#/src/test/java/ortus/boxlang/modules/encrypt/components" );
	...
	function run(
		...
		if( listLen( package, "." ) == 1 ){
			arguments.package = "ortus.boxlang.modules.encrypt.components." & package;
		}
